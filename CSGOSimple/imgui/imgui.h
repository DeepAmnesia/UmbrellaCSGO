...
namespace ImGui
{
    ...
    IMGUI_API bool          Keybind(const char* str_id, int& key, int& mode);
    IMGUI_API float         CalcMaxPopupHeightFromItemCount(int items_count);               // add vertical spacing.
    ...
    IMGUI_API bool          Combo(const char* label, int* current_item, std::vector<const char*> arr);
    // Widgets: Drags
