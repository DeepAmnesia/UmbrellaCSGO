...
void* C_KeyValues::operator new(size_t allocatedsize)
{
    ...
    return CallVFunction< PVOID(__thiscall*)(PVOID, size_t) >(pKeyValuesSystem, 2)(pKeyValuesSystem, allocatedsize);
}
...
void C_KeyValues::operator delete(void* mem)
{
    ...
    return CallVFunction< void(__thiscall*)(PVOID, PVOID) >(pKeyValuesSystem, 3)(pKeyValuesSystem, mem);
}
...
{
    return ((FindKey_t)(g_cheat.m_KeyValuesFindKey))(this, strKeyName, bCreate);
}

const char* C_KeyValues::GetString(C_KeyValues* pThis, const char* strKeyName, const char* strDefaultValue)
{
    return ((GetString_t)(g_cheat.m_KeyValuesGetString))(pThis, strKeyName, strDefaultValue);
}
...
{
    return ((LoadFromBuffer_t)(g_cheat.m_KeyValuesLoadFromBuffer))(pThis, pszFirst, pszSecond, pSomething, pAnother, pLast, pAnother2);
}
...
void C_KeyValues::SetString(const char* strName, const char* strValue)
{
    ...
    if (pKeyValues)
        ((SetString_t)(g_cheat.m_KeyValuesSetString))(pKeyValues, strValue);
}
