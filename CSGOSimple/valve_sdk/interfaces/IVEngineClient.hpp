...
public:
	...
	virtual void                  ServerCmdKeyValues(C_KeyValues *pKeyValues) = 0; // 203
	...
	virtual void                  StartLoadingScreenForKeyValues(C_KeyValues* values) = 0;
	...
	virtual void                  SetDemoImportantEventData(const C_KeyValues* values) = 0;
